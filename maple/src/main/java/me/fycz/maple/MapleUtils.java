...
public final class MapleUtils {
    ...
    private abstract static class MemberCacheKey {
        ...
        static final class Constructor extends MemberCacheKey {
            ...
            public boolean equals(Object o) {
                ...
                if (!(o instanceof MemberCacheKey.Constructor)) return false;
                MemberCacheKey.Constructor that = (MemberCacheKey.Constructor) o;
        ...
        static final class Field extends MemberCacheKey {
            ...
            public boolean equals(Object o) {
                if (this == o) return true;
                if (!(o instanceof MemberCacheKey.Field)) return false;
                MemberCacheKey.Field field = (MemberCacheKey.Field) o;
        ...
        static final class Method extends MemberCacheKey {
            ...
            public boolean equals(Object o) {
                if (this == o) return true;
                if (!(o instanceof MemberCacheKey.Method)) return false;
                MemberCacheKey.Method method = (MemberCacheKey.Method) o;
    ...
    public static MapleBridge findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        ...
        return MapleBridge.hookMethod(m, callback);
    }
     ...
     * an anonymous subclass of {@link MethodHook} or {@link MethodReplacement}.
     *
     * <p><b>Example</b>
     ...
     * findAndHookMethod("com.example.SomeClass", lpparam.classLoader, String.class, int.class, "com.example.MyClass", new MethodHook() {
     *   &#64;Override
